      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 border-b border-white/5 bg-dark-900/40">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 border border-white/5 hover:border-brand-purple/20 bg-dark-900/60 hover:bg-dark-800/80 rounded-xl text-xs font-semibold text-gray-300 transition"
          >
